...
class AddExpenseFragment : Fragment() {
    ...
    private lateinit var etAmountSpent: EditText
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        etAmountSpent = view.findViewById(R.id.etAmountSpent)
        ...
        val btnBackExpense = view.findViewById<Button>(R.id.btnBackExpense)

        btnBackExpense.setOnClickListener {
            findNavController().popBackStack() // navigate back to ExpensesFragment
        }
    ...
    private fun loadCategories() {
        db.collection("categories")
            ...
            .addOnSuccessListener { result ->
                ...
                if (isAdded) { // Add this safe check
    ...
    private fun saveExpense() {
        ...
        val amountSpentText = etAmountSpent.text.toString().trim()
        val amountSpent = if (amountSpentText.isNotEmpty()) amountSpentText.toDouble() else 0.0
